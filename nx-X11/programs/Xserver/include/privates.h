 ...
 * may set and get a single void * value using this private key. Otherwise,
 ...
 * Otherwise, it returns the place where the private void * is stored.
 */
static inline void *
...
/*
 * Fetch a private void * stored in the object
 *
 * Returns the void * stored with dixSetPrivate.
...
/*
 * Lookup a void * to the private record.
 *
...
/*
 * Look up the address of the void * to the storage
 *
 * This returns the place where the private void * is stored,
