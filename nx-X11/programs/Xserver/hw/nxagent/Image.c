                                ...
                                char *data, Visual *pVisual)
{
   ...
   * what we would need to do is just creating an appropri- ate XImage
...
FIXME: There should be a callback registered by the agent that
       ...
       were found, how many drawables are to be synch- ronized,
...
*/
                ...
                packMethod == PACK_BITMAP_16M_COLORS)
    {
       ...
       * padding bytes. In other words, bitmap images prod- ucing the
