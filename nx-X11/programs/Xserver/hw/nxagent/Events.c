...
int nxagentHandleXFixesSelectionNotify(XEvent *X)
{
  ...
  if (SelectionCallback)
  {
    ...
    if (i < NumCurrentSelections)
    {
      ...
      fprintf(stderr, "%s: Event selection remote [%ld] local [%d][%s]\n", __func__, xfixesEvent->xfixesselection.selection, nxagentRemoteToLocalAtom(xfixesEvent->xfixesselection.selection), NameForAtom(nxagentRemoteToLocalAtom(xfixesEvent->xfixesselection.selection)));
